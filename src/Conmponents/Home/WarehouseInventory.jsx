...
const wareHouse = [
  {
    ...
    title2:
      "https://jmminnovations.com/_next/static/media/WAIMS.afaf87ed.png?imwidth=640",
    img1: "https://jmminnovations.com/_next/static/media/Cs_1_1.1f52ab58.png?imwidth=640",
    img2: "https://jmminnovations.com/_next/static/media/Cs_4_1.96378570.png?imwidth=640",
    desc: "We developed a distribution and inventory management services for  online stores, linking them to a delivery system and providing various payment options for customers.",
  },
];
...
const Features = [
  {
    id: 1,
    title: "Mobile application; operates in English and Arabic",
  },
  {
    id: 2,
    title:
      "The application features multiple modules; including: • Warehouse and inventory Management",
  },
  {
    id: 3,
    title: "Ticketing",
    ...
    <>
      ...
      <div className="flex mt-8 flex-col md:flex-row ">
        ...
        <div className="md:w-1/2 mb-7">
          <img className="w-full" src="https://jmminnovations.com/_next/static/media/Cs_1_3.d399d15d.png?imwidth=640" alt="" />
        </div>
      </div>
