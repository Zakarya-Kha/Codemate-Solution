...
const wareHouse = [
  {
    ...
    title2:
      "https://jmminnovations.com/_next/static/media/WMS.7c6e9ddb.png?imwidth=256",
    img1: "https://jmminnovations.com/_next/static/media/Cs_4_1.96378570.png?imwidth=640",
    img2: "https://jmminnovations.com/_next/static/media/Cs_4_2.2b741f6e.png?imwidth=640",
...
const Features = [
  {
    id: 1,
    title: "Operates in English and Arabic",
  },
  {
    id: 2,
    title: "Orders and return management",
  },
  {
    id: 3,
    title:
  ...
  {
    id: 5,
    title: "Store integration and management • AWB generation",
  },
 
];

const WareHouseMaanagement = () => {
  return (
    <>
    {wareHouse.map((item) => (
      <div key={item.id}>
    ...
    <div className="flex mt-8 flex-col md:flex-row ">
      ...
      <div className="md:w-1/2 mb-7">
        <img className="w-full" src="https://jmminnovations.com/_next/static/media/Cs_4_3.d399d15d.png?imwidth=640" alt="" />
      </div>
    </div>
...
export default WareHouseMaanagement
