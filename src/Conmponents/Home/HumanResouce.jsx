...
const wareHouse = [
  {
    ...
    title2:
      "https://jmminnovations.com/_next/static/media/HRM.1eb301a9.png?imwidth=256",
    img1: "https://jmminnovations.com/_next/static/media/Cs_7_1.f6f0472b.png?imwidth=640",
    img2: "https://jmminnovations.com/_next/static/media/Cs_7_2.e8d7e0c7.png?imwidth=640",
    desc: "We developed a mobile and web-based Human Resource Management System for Hayat AlQassim. The solution provides tracking employee attendance, overtime, abilities, salaries, and accomplishments. Managers can easily declare extra working hours, holidays or absences and other information necessary for payroll, allowing LIVE and integrated monitoring of presence.  ",
  },
];
...
const Features = [
  ...
  {
    id: 2,
    title: "Gathering, storing, and accessing employee information",
  },
  {
    id: 3,
    title:
  ...
  {
    id: 5,
    title: "Benefits admin page iteration",
  },
  {
    id: 6,
  ...
  {
    id: 7,
    title: "Analytics and informed decision making",
  }
  ...
  return (
    ...
    <div className="flex mt-8 flex-col md:flex-row ">
      ...
      <div className="md:w-1/2 mb-7">
        <img className="w-full" src="https://jmminnovations.com/_next/static/media/Cs_7_3.01e01510.png?imwidth=640" alt="" />
      </div>
    </div>
