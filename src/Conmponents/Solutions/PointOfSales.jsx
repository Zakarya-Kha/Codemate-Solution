  ...
  return (
    <>
      <div
        ...
        style={{
          backgroundImage:
            "url('https://jmminnovations.com/assets/images_new/product_solution/detailPage//POS@2x.png')",
        }}
      >
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-start px-8 lg:px-16">
          <div className="bg-white bg-opacity-80 p-8 lg:p-9 max-w-3xl">
            ...
            Our POS system allows your business to accept payments from customers and keep track of sales. With our solution you can record, identify and manage your company’s transactions in real-time. You can also access your purchasing and selling history in one dashboard. 
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row md:my-0 my-16">
        ...
        <div className="border bg-purple-200 md:w-1/2 md:mt-0 mt-6">
          <img
            ...
            src="https://jmminnovations.com/_next/static/media/POS_One@2x.751a051e.png?imwidth=1920"
            alt=""
          />
        </div>
      </div>
